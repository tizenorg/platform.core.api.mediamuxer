...
typedef enum {
	...
	MEDIAMUXER_ERROR_INVALID_URI = TIZEN_ERROR_MEDIA_MUXER | 0x02,			/**< Invalid URI */
 ...
 * @since_tizen 3.0
 * @remarks If you use FILE, path should start with "file://". The supported protocol is "file://".
 *          If you provide an invalid path, you will receive an error message.
 ...
 * @retval #MEDIAMUXER_ERROR_INVALID_URI Invalid URI
