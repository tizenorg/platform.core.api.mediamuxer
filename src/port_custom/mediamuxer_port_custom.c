...
/*
 * @file mediamuxer_port_custom.c
 * @brief contain the function definitions etc of mediamuxer custom port
...
static int custom_muxer_get_data_count(MMHandleType pHandle, int *count);
static int custom_muxer_get_track_info(MMHandleType pHandle, void *info);
static int custom_muxer_set_track(MMHandleType pHandle, int track);
static int custom_muxer_get_data(MMHandleType pHandle, char *buffer);
...
static media_port_muxer_ops def_mux_ops = {
	...
	.get_data_count = custom_muxer_get_data_count,
	.get_track_info = custom_muxer_get_track_info,
	.set_track = custom_muxer_set_track,
	.get_data = custom_muxer_get_data,
};
